...
!!! note "SKEW의 역사적 변화 — 임계 재캘리브레이션 (2026-05)"
    2020년 이전에는 SKEW 평균이 ~115였고 140 이상은 매우 드물었습니다. 2020년 이후 구조적으로 상향 이동하여 **현재 median ≈ 145, p75 ≈ 150, p95 ≈ 157**. 옛 임계 140/150은 "기본 상태"가 돼버려 의미를 잃었기에, 일일 대시보드는 **150 경계 / 158 스트레스**로 재캘리브레이션(p75/p95)했습니다. 위 표는 그 기준입니다.
