...
- **힘셉니다.** 수 kg짜리 부품부터, 화낙의 초대형 모델(M-2000iA)은 **2톤이 넘는 차체**까지 듭니다.
...
![규격이 인정하는 네 가지 협동 방식](../assets/diagrams/cobot-four-methods.svg)
...
![대체가 아니라 시장 확대](../assets/diagrams/cobot-market-expansion.svg)
...
- **화낙(FANUC)** — 산업용 로봇의 절대 강자(ABB·KUKA·야스카와와 함께 '빅4')이자 공작기계 **CNC 제어기**의 지배적 공급자. 2023년 **누적 100만 대** 로봇 출하를 발표했죠. 코봇 카테고리엔 **CRX 시리즈**로 응수했습니다 — UR의 '쉬움'을 정면으로 겨눈 제품이죠. 예: **CRX-25iA(25kg 가반, 리치 1,889mm)**.
...
**기억할 한 가지:** 코봇의 혁신은 로봇을 더 세게 만든 게 아니라, **안전 펜스와 전문 통합이라는 진입장벽을 없앤 것**입니다. 그래서 코봇 이야기는 곧 "누가 그 접근성을 가장 잘 파느냐"의 이야기이고 — [다음 편](cobot-ur-vs-fanuc.md)에서 **UR과 화낙의 제품을 정면으로 비교**한 뒤, [3부](cobot-investing.md)에서 이걸 **Physical AI 투자 관점(UR=Teradyne · 화낙 · NVIDIA)**으로 연결해 보겠습니다.
