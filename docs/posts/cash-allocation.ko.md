...
공격 통은 평소엔 100% 현금이고, T1·T2·T3 트리거가 발동될 때만 풀립니다. 즉 *대부분의 날* 은 그냥 잠자는 돈. SPX 장기 기대수익률 ≈ 9%/yr 가정 시:
...
같은 트리거에서 공격 통이 100% 투입돼도, 그게 전체 자산에 미치는 영향은 비율에 따라 다릅니다:
...
**99%의 날은 공격 통 = 그냥 현금**. 1%를 위해 얼마를 묶을지가 결정 포인트입니다.
