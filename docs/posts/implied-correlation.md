...
lang: ko
series-prev: "[Hedging the Wings](./2023-1-17_#옵션%20-%20Hedging%20the%20wings.md)"
---

# 시장 심리 변동성 지수 — Implied Correlation과 IV Surface

> 관련 글: [변동성 Skew](./2023-1-14_#옵션%20-%20블랙핑크%20지수의%20썩소와%20S&P500%20지수의%20썩소.md) | [Hedging the Wings](./2023-1-17_#옵션%20-%20Hedging%20the%20wings.md)
...
S&P500 지수 옵션에는 [변동성 왜곡(Volatility Skew)](./2023-1-14_#옵션%20-%20블랙핑크%20지수의%20썩소와%20S&P500%20지수의%20썩소.md) 현상이 있습니다. 내재상관관계의 Delta Skew 지수들을 한 그래프에 그리면, IV 왜곡의 곡선 모양이 아닌 **거의 직선**으로 표시됩니다.
...
이 간격의 변화를 모니터링하면, 변동성 Skew의 변화를 실시간으로 추적할 수 있습니다.

> COR 지수들은 CBOE 웹사이트에서 실시간 데이터를 확인할 수 있습니다.
...
*이전 글: [Hedging the Wings](./2023-1-17_#옵션%20-%20Hedging%20the%20wings.md) | 관련 글: [변동성 Skew](./2023-1-14_#옵션%20-%20블랙핑크%20지수의%20썩소와%20S&P500%20지수의%20썩소.md)*
