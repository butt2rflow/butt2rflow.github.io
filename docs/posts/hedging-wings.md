...
> **실행 난이도 안내:** 이 글에서 소개하는 1:2 Put Ratio Spread는 옵션 경험이 있는 투자자를 대상으로 합니다. SPX 지수 옵션 또는 SPY ETF 옵션으로 실행할 수 있으며 (SPY는 계약 단위가 작아 개인투자자에게 더 접근하기 쉽습니다), 일반 개인투자자에게는 아래 이유들로 실행이 쉽지 않은 전략입니다:
>
...
> - **어정쩡한 하락 구간**: 합성 포지션이 완만한 하락 구간에서는 손실이 발생할 수 있으며, 롤오버 타이밍 판단이 필요합니다
>
...
1:2 put ratio 숏 포지션의 경우 상시 헷지 비용은 **ATM put 단일 매수(연 18~30%) 대비 약 1/10 수준인 투자금액 대비 연 2~3%**입니다.
