...
**핵심**: VIX 지수는 단일 시점의 기대 변동성. VIX 선물은 *미래의 30일 기대 변동성*을 거래하는 시장의 가격. 따라서 만기마다 가격이 다르고, 그 가격들을 이으면 **곡선(term structure)**이 됩니다.
...
| 신호 | 의미 | 색깔 |
|:----|:-----|:-----|
| **VIX 지수 < Front month** | 가장 흔한 상태 (콘탱고 시작) | 🟢 평상시 |
| **VIX 지수 > Front month** | **백워데이션** — 단기 스트레스 시작 | 🔴 경고 |
