...
| 지표 | 값 | 의미 |
|:----|:---|:-----|
| **중앙값 (50th)** | ~$1,081 | 절반의 경우 50일 후 약 8% 수익 |
| **5th percentile (VaR 95%)** | ~$880 | 최악의 5% 시나리오에서 -12% 손실 |
| **95th percentile** | ~$1,320 | 최선의 5% 시나리오에서 +32% 수익 |
| **손실 확률 (< $1,000)** | ~31% | 10번 중 3번은 원금 손실 |
| **최대 낙폭** | ~-25% | 가장 나쁜 경로에서의 최저점 |

> **핵심:** 몬테카를로 시뮬레이션의 가치는 "평균 수익률"이 아니라 **"최악의 시나리오에서 얼마나 잃을 수 있는가"**를 미리 알 수 있다는 것입니다. 이것이 VaR(Value at Risk)이며, 금융 기관이 리스크 관리에 몬테카를로를 사용하는 핵심 이유입니다.
