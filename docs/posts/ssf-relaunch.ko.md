...
기초자산은 S&P 500 · 나스닥100 · 러셀1000에서 뽑았습니다. Alphabet, Amazon, Apple, Meta, Nvidia, Tesla, Microsoft, Micron, 그리고 최근 상장한 **SpaceX**까지. CME는 이 55종목이 일평균 명목거래대금 2,000억 달러 이상, 지수 비중 기준으로 S&P 500과 나스닥100의 대략 **55~65%**를 커버한다고 밝혔습니다.
...
CME 자체 FAQ가 이 부분을 다루는 방식이 시사적입니다. 질문 제목에는 60/40을 언급하는데 답변은 국제투자자 §871(m) 원천징수 얘기만 합니다. 비거주자에게 실질적으로 중요한 항목이 후자고, CME는 규정집 Chapter 9 Rule 990의 중개기관·QDD 체계로 처리합니다. 세무 처리는 본인 회계사와 확인하세요. 저는 세무 전문가가 아닙니다.

### 9월 18일에 볼 것

첫 네마녀의 날이면서 동시에 이 상품군의 **첫 만기**입니다.

- **12월물 롤** — Sep→Dec가 유일한 선택지. 롤 기준일은 세 번째 금요일 직전 월요일, **9월 14일**. 미결제약정이 이월되는지 소멸하는지가 이 상품의 성격을 말해줍니다.
