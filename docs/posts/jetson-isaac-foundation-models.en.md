...
lang: en
description: "We put the 'grab a new part with no training' foundation-model pipeline on a palm-sized edge computer and ran it. Field notes from proving the concept on a Jetson Orin NX with Isaac ROS — what runs, and what the next step is. Part 2 of 2."
---
...
![The second object — only the CAD file was swapped, to an electric drill](../assets/demos/jetson-foundationpose-desk.gif)
