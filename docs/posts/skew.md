...
| 옵션 기초 | 권장 | 콜/풋, 행사가, ITM/OTM 구분 |
| VIX | 권장 | S&P500의 30일 내재변동성 지수 |
...
**쉽게 말하면:** 상승장에서는 종목마다 제각각 움직이지만, 하락장에서는 모든 종목이 한꺼번에 같이 떨어집니다. 이 "같이 떨어지는 정도"가 상관관계이고, 이것이 지수 옵션의 변동성 왜곡을 만드는 원인입니다.
