...
더 정확히는, 이 *현금이라는 연료*에는 두 종류가 섞여 있습니다 — 폭락 cascade에서 *살아남기 위한* **방어 자본**과, 위기 한복판에서 *시간 에지를 행사하기 위한* **공격 자본**. 이 둘을 분리해야 비로소 "변동성을 연료로"가 완성됩니다 (실전 분리법은 [현금 비중 글](../posts/cash-allocation.md) Section 4 심화 박스).
