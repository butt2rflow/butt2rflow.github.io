...
- Full 2006–2025 SPY backtest: Sharpe 0.56 → 0.79, max drawdown -55.2% → -35.7%
- Custom **BF_VolVol** Pine Script for TradingView
- IVTS three-zone framework (Collecting / Warning / Defending)
- Honest limits — what each signal does well, where each one whipsaws

> 🇰🇷 [한글 버전 보기](../series/s2-preview.md) · 🇺🇸 [English series index](index.md)
