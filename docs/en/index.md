...
# Why Volatility Pays — English Edition

**A four-series, 13-article curriculum on volatility, options, and gamma — for the retail investor who wants math, not vibes.**

In an age where AI dominates the markets in milliseconds, the *information edge* is closed to retail. But the math hasn't changed. Volatility still exists, compounding still works, and over-betting still ruins accounts. This series is your guide to using those constants.
...
!!! info "About the author"
    butterflow — a retail investor who treats volatility not as an enemy but as fuel. Researching and writing on math- and data-driven investment principles. Korean originals available at [butt2rflow.github.io](../index.md).
