...
<small>*공격 자본은 *시간 에지를 행사하는 위기 매수 현금*으로 별도 운용. T1(VIX 지속)은 40/50/60 단계별 가중치, T2·T3는 0/1 이진. 총 가중치를 3으로 나눠 투입 % 산출, 100% 초과는 cap. 위 카드의 투입 %는 **공격 자본 내부 기준** — 전체 자산 환산과 분할 비율은 페이지 상단 마스터 바 참조 · [자세히 →](posts/cash-allocation.md)*</small>
